...
var config = {
  ...
  { name: 'r1-atsi', weight: 1, message: 'atsi', repitition: 'r1' },
  { name: 'r2-atsi', weight: 1, message: 'atsi', repitition: 'r2' },
  { name: 'r4-atsi', weight: 1, message: 'atsi', repitition: 'r4' },
  { name: 'r14-atsi', weight: 1, message: 'atsi', repitition: 'r14' } ],
    /** **endings**
